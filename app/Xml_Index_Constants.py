class XMLIndexConstants:
    """
    Clase de constantes para indexar y acceder fácilmente a etiquetas específicas
    dentro de archivos XML de configuración de la aplicación.

    Contiene constantes tanto para la configuración general de la app como para
    la configuración de los prompts por idioma.
    """
